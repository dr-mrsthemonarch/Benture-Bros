void loop(void)
{
  ...
  filter0.update(gyro[0][0], gyro[0][1], gyro[0][2], accel[0][0], accel[0][1], accel[0][2], mag[0][0], mag[0][1], mag[0][2]);
  filter1.update(gyro[1][0], gyro[1][1], gyro[1][2], accel[1][0], accel[1][1], accel[1][2], mag[1][0], mag[1][1], mag[1][2]);
  filter2.update(gyro[2][0], gyro[2][1], gyro[2][2], accel[2][0], accel[2][1], accel[2][2], mag[2][0], mag[2][1], mag[2][2]);
  filter3.update(gyro[3][0], gyro[3][1], gyro[3][2], accel[3][0], accel[3][1], accel[3][2], mag[3][0], mag[3][1], mag[3][2]);
  filter4.update(gyro[4][0], gyro[4][1], gyro[4][2], accel[4][0], accel[4][1], accel[4][2], mag[4][0], mag[4][1], mag[4][2]);
  filter5.update(gyro[5][0], gyro[5][1], gyro[5][2], accel[5][0], accel[5][1], accel[5][2], mag[5][0], mag[5][1], mag[5][2]);

  // Call All Euler Angle Rotations around {X,Y,Z} or {gamma, delta, epsilon}
  double eulerAngles[6][3] =  {
  ...
  Serial.print(",");
  Serial.print(eulerAngles[1][0]); // print in degrees
  Serial.print(",");
  Serial.print(eulerAngles[2][0]); // print in degrees
  Serial.print(",");
  Serial.print(eulerAngles[3][0]); // print in degrees
  Serial.print(",");
  Serial.print(eulerAngles[4][0]); // print in degrees
  Serial.print(",");
  Serial.println(eulerAngles[5][0]); // print in degrees
