...
std::array<SensorCaller2, 6> mpu9250 = {
    SensorCaller2(230, 26, {0.9957, 0.9983, 0.9810, -0.0235, -0.0544, -0.0083}, {4.7, 7.96, -46.23}, {{{0.717, 0.081, -0.023}, {0.081, 1.301, 0.029}, {-0.023, 0.029, 1.082}}}),
    SensorCaller2(230, 14, {0.9980, 0.9978, 0.9785, -0.0057, -0.0306, 0.0392}, {26.77, -10.76, -8.34}, {{{1.135, -0.012, 0.174}, {-0.012, 0.969, 0.011}, {0.174, 0.011, 0.936}}}),
    SensorCaller2(230, 21, {0.9975, 0.9978, 0.9811, -0.0165, -0.0383, 0.0769}, {5.63, 11.97, -38.13}, {{{0.714, -0.109, 0.048}, {-0.109, 1.275, -0.027}, {0.048, -0.027, 1.118}}}),
    SensorCaller2(230, 27, {0.9970, 0.9986, 0.9791, -0.0055, -0.0418, -0.0117}, {35.62, 3.48, -2.13}, {{{1.096, 0.003, -0.119}, {0.003, 1.050, 0.035}, {-0.119, 0.035, 0.884}}}),
    SensorCaller2(230, 32, {0.9964, 0.9976, 0.9739, -0.0080, -0.0375, 0.0835}, {7.78, 27.29, -5.58}, {{{0.861, 0.067, -0.065}, {0.067, 1.255, -0.050}, {-0.065, -0.050, 0.936}}}),
    SensorCaller2(230, 25, {0.9978, 0.9986, 0.9773, -0.0880, -0.1338, -0.1203}, {20.67, 14.87, -23.49}, {{{1.01, 0.013, 0.028}, {0.013, 1.033, -0.009}, {0.028, -0.009, 0.959}}})};
