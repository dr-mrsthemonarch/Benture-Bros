...
std::array<float, 3> magnetic_field = {39.09, 37.16, 0};

//Class objects
std::array<SensorCaller2, 2> testing = {
  SensorCaller2(250, 14, {0.0478, 0.0328, 0.2179}, {10.58, 33.41, -51.91} , {{{ 0.996, 0.015, -0.001 },  -0.014, 0.998, 0.014 , { -0.001, 0.015, 1.007 }}}),
  SensorCaller2(250, 32, {0.0478, 0.0328, 0.2179}, { -10.33, 18.06, -5.73}, {{{ 1.011, -0.029, -0.005 }, { -0.029, 1.013, 0.029 }, { -0.005, 0.029, 0.978 }}})
};

std::array<float, 3> phiRPY;
std::array<float, 3> thetaRPY;
std::array<float, 3> psiRPY;
std::array<float, 3> matPhi;
std::array<float, 3> matTheta;
std::array<float, 3> matPsi;
std::array<float, 3> u;
...
Vector3f lqrTheta(matPhi[0], matPhi[1], matPhi[2]);
Vector3f lqrPsi(matPhi[0], matPhi[1], matPhi[2]);
